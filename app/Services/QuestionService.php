...
class QuestionService 
{
    ...
    public function getByCategory(string $category): array
    {
        ...
        $questions = $causer->isUser()
            ? $this->model->where('user_id', $causer->id)::getByCategory($category)->get()
            : $this->model::getByCategory($category)->get();

        $this->logger->log($causer->name, 'Filtered by category: ' . $category, 'question', 'filtered');
