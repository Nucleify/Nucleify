...
$colors = array_merge(
    require __DIR__ . '/DefaultColors/Activity.php',
    require __DIR__ . '/DefaultColors/Article.php',
    require __DIR__ . '/DefaultColors/Card.php',
    ...
    require __DIR__ . '/DefaultColors/User.php'
);
