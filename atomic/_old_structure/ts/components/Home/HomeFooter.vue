  ...
  <section id="footer">
    <div
      ...
      v-animateonscroll="{
        enterClass: 'fadein',
        leaveClass: 'fadeout',
        rootMargin: isMobile() ? '250px' : '100px',
      }"
    >
      <div class="top">
