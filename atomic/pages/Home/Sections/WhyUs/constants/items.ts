import { WhyUsItemInterface } from 'atomic'
...
export const whyUsData: { items: WhyUsItemInterface[] }[] = itemsData.reduce(
  (result, item, index): { items: WhyUsItemInterface[] }[] => {
    if (index % 2 === 0) {
      result.push({
